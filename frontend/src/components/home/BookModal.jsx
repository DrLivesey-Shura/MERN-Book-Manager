    ...
    >
      <div className="w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative">
        ...
        <p className="my-2">
          ...
          iste omnis? Illo, eius assumenda suscipit quibusdam aspernatur error
          itaque nesciunt possimus accusamus fuga culpa est adipisci labore
          molestiae praesentium earum beatae officia magni iure alias eligendi
          velit? Tempore libero animi vitae eum ipsum qui quibusdam, aperiam
          repellat ad ex!
        </p>
      </div>
    </div>
